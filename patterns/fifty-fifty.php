...
<!-- wp:heading {"style":{"typography":{"textTransform":"uppercase","fontStyle":"normal","fontWeight":"700"},"spacing":{"margin":{"top":"0"}}},"fontFamily":"montserrat"} -->
<h2 class="wp-block-heading has-montserrat-font-family" style="margin-top:0;font-style:normal;font-weight:700;text-transform:uppercase">Creamos momentos que resuenan.</h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"style":{"typography":{"lineHeight":"1.1"}},"fontSize":"large"} -->
<p class="has-large-font-size" style="line-height:1.1">Desde lanzamientos de productos hasta activaciones de marca. Descubrí lo que podemos hacer por vos y tu marca.</p>
<!-- /wp:paragraph -->
